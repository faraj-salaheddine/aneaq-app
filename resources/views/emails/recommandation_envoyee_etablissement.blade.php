<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title>Recommandations DEE</title></head>
...
<div style="max-width:620px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
    <div style="background:linear-gradient(90deg,#0C447C,#2563eb);color:white;padding:24px 28px;">
        <h1 style="margin:0;font-size:20px;">📋 Recommandations d'évaluation</h1>
    ...
    <div style="padding:28px 32px;">
        ...
        <p style="font-size:14px;color:#64748b;margin:0 0 20px;">
            La DEE vous a transmis <strong>{{ $nombreRecommandations }} recommandation(s)</strong> suite à l'évaluation de votre dossier <strong>{{ $dossierReference }}</strong>.
        </p>
        <div style="background:#eff6ff;border:1px solid #bfdbfe;border-left:4px solid #2563eb;border-radius:10px;padding:16px 20px;margin-bottom:24px;">
            <p style="font-size:13px;color:#1e40af;margin:0;">
                Veuillez consulter chaque recommandation sur la plateforme, indiquer votre <strong>délai de mise en œuvre</strong> et déposer vos <strong>preuves de réalisation</strong> au fur et à mesure.
            </p>
        </div>
