...
<head>
    ...
    <title>Mise à jour de votre compte ANEAQ</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge { display: inline-flex; align-items: center; gap: 6px; background: #eff6ff; color: #0C447C; padding: 6px 14px; border-radius: 99px; font-size: 13px; font-weight: 700; margin-bottom: 24px; }
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="text">
                Nous vous informons que les informations de votre compte sur la plateforme ANEAQ ont été mises à jour par un administrateur.
            </p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $utilisateur->user->email }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $utilisateur->role === 'chef_dee' ? 'Chef DEE' : 'DEE' }}</span>
                </div>
                @if($password)
                <div class="info-row">
