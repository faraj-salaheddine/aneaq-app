...
export default function Create() {
    const [form, setForm] = useState({
        ...
        telephone: "", cin_number: "",
        contract_start: "", contract_end: "", contract_renewals: "",
        car_horsepower: "",
    });
            ...
            <div className="create-root" style={{ padding: "2.5rem 3rem", minHeight: "100vh", background: "linear-gradient(160deg, #f8fafc 0%, #f1f5f9 100%)" }}>
                ...
                <div style={{ marginBottom: "2.5rem" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
                        <button onClick={() => router.visit("/si/experts")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 5, color: "#94a3b8", fontSize: 12, fontWeight: 500, padding: 0 }}
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                        ...
                        <div className="section-card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 18, padding: "2rem", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
                            <SectionHeader
                                ...
                                subtitle="Informations personnelles obligatoires"
                            />
                        ...
                        <div className="section-card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 18, padding: "2rem", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                                <Field label="Numéro CIN" error={errors.cin_number}>
                        ...
                        <div className="section-card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 18, padding: "2rem", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
                            <SectionHeader
                                ...
                                subtitle="Optionnel — Détails du contrat de l'expert"
                            />

                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, marginBottom: 16 }}>
                                <Field label="Date de début" error={errors.contract_start}>
                                ...
                                <Field label="Date de fin" error={errors.contract_end}>
                                ...
                                <Field label="Nombre de renouvellements" error={errors.contract_renewals}>
                            ...
                            <FileUpload label="Document du contrat" name="contract_file" accept="image/*,.pdf" file={files.contract_file} onChange={v => setFile("contract_file", v)} hint="Scan ou photo du contrat signé · JPG, PNG, PDF" />
                        </div>
                        ...
                        <div className="section-card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 18, padding: "2rem", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
                            <SectionHeader
                                ...
                                subtitle="Optionnel — Informations du véhicule de l'expert"
                            />

                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                                <Field label="Puissance fiscale (CV)" error={errors.car_horsepower}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 20, position: "sticky", top: "2rem" }}>
                        ...
                        <div className="section-card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 18, padding: "1.75rem", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
                            <SectionHeader
                                ...
                                title="Mot de passe"
                                subtitle="Obligatoire — min. 8 caractères"
                            />
                            ...
                            <div style={{ marginBottom: 10 }}>
                                ...
                                <div style={{ position: "relative" }}>
                                    <input
                                        ...
                                        style={{ ...inputStyle(errors.password), paddingRight: 40, fontFamily: showPassword ? "'DM Mono', monospace" : "inherit", letterSpacing: showPassword ? "0.05em" : "inherit" }}
                                    />
                                ...
                                {showPassword && form.password && (
                                    <div style={{ marginTop: 8, padding: "8px 12px", borderRadius: 8, background: `${GREEN}08`, border: `1px solid ${GREEN}20`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                        <span style={{ fontSize: 12, fontFamily: "'DM Mono', monospace", color: GREEN, fontWeight: 600, letterSpacing: "0.05em", wordBreak: "break-all" }}>
                                            {form.password}
                                        </span>
                                        <button type="button" onClick={() => navigator.clipboard.writeText(form.password)}
                                            style={{ background: "none", border: "none", cursor: "pointer", color: GREEN, fontSize: 11, fontWeight: 700, padding: "0 0 0 8px", whiteSpace: "nowrap" }}
                                        >
                                            Copier
                                        </button>
                                    </div>
