...
class ExpertController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLog::create([
            ...
            'role'         => Auth::user()->role,
            'details'      => 'Création du compte expert — ' . $expert->email,
        ]);
    ...
    public function update(Request $request, Expert $expert)
    {
        ...
        $fields = [
            ...
            'ville', 'cin_number', 'rib', 'contract_start',
            'contract_end', 'contract_renewals', 'car_horsepower',
        ];
        ...
        $labels = [
            ...
            'contract_renewals' => 'Renouvellements',
            'car_horsepower'    => 'Puissance (CV)',
        ];
        ...
        $details = count($changes) > 0 ? implode(' | ', $changes) : 'Aucun changement détecté';
    ...
    public function destroy(Expert $expert)
    {
        ...
        ActivityLog::create([
            ...
            'performed_by' => Auth::user()->name,
            'role'         => Auth::user()->role,
            'details'      => 'Suppression du compte expert — ' . $expert->email,
        ]);
